...
Iter offers the exchange protocol, which allows users to trade digital assets at their preferred prices and quantities. Whether you're a seasoned trader or new to the digital market, exchange offers the tools to buy and sell with precision and control.
...
Before delving into an Iter monorepo project, ensure your environment is prepared and know how to use these tools.
...
Navigate your way through the Iter exchange contracts with the following procedures:
...
If you discover any security issues or vulnerabilities, please report them responsibly to our team via [official communication channel](mailto:contact@iter.cx).
