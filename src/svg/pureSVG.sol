    ...
    function generateSVGDefs() private pure returns (string memory svg) {
        ...
        svg = string(
            abi.encodePacked(
                ...
                "https://raw.githubusercontent.com/iter-cx/nft-arts/main/V1/backgrounds/",
                "1088",
                ".png",
                '"',
                " />",
    ...
    function generateNetwork() internal pure returns (string memory svg) {
        svg = string(
            abi.encodePacked(
                ...
                "https://raw.githubusercontent.com/iter-cx/nft-arts/main/V1/networks/",
                "1088",
                ".png",
                '" />'
            )
    ...
    function generateTokenLogos() internal pure returns (string memory svg) {
        svg = string(
            abi.encodePacked(
                ...
                "https://raw.githubusercontent.com/iter-cx/nft-arts/main/V1/tokens/",
                "4",
